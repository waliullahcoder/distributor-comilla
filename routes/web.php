...
Route::group(['as' => 'frontend.'], function () {
    ...
    route::get('/campaign/{slug}', [FrontpageController::class, 'campaign'])->name('campaign');
    route::get('/package-checkout/{slug}', [FrontpageController::class, 'packageCheckout'])->name('package-checkout');
    route::post('/package-order', [FrontpageController::class, 'packageOrder'])->name('package-order.store');
    route::get('/thank-you/{id}', [FrontpageController::class, 'thankYou'])->name('thank-you');
});
