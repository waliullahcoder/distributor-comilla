...
class Sales extends Model
{
    ...
    protected $fillable = ['company_id', 'product_type', 'store_id', 'staff_id', 'client_id', 'invoice', 'date', 'sales_type', 'total_amount', 'discount', 'total_paid', 'status', 'created_by', 'updated_by', 'deleted_by'];
