...
class User extends Authenticatable
{
    ...
    public function moderatorOrders()
    {
    ...
    {
        return $this->hasMany(ModeratorTeamMember::class, 'user_id');
    }

    public function leaders()
    {
        return $this->hasMany(ModeratorTeam::class, 'team_leader');
    }

    public function leader()
    {
        return $this->belongsTo(ModeratorTeam::class, 'id', 'team_leader');
    }
}
