...
class PaymentController extends Controller
{
    ...
    public function invoice()
    {
        ...
        $pay_data = InvestorPayment::withoutGlobalScope(CompanyScope::class)->withTrashed()->select(['payment_no'])->where('created_at', '>=', $first)->where('created_at', '<=', $last)->latest('id')->first();
        if ($pay_data) {
