    ...
    public function deliveryStatement(Request $request)
{
    ...
    */
        ...
        if ($request->has('filter')) {
            ...
            $query = DB::table('lifting_products')
                ...
                if ($request->product_type == 'Consumer' || is_null($request->product_type)) {
                    ...
                    $liftings = $this->liftingFun($store_id,$product_ids);
                    $lifting_returns = $this->lifting_returnFun($store_id,$product_ids);
                    $sales = $this->salesFun($store_id,$product_ids);
                    $sales_returns = $this->sales_return_listsFun($store_id,$product_ids);
                    $online_sales =  $this->online_salesFun($store_id,$product_ids);
                    $transfer_or_receives = $this->transfer_or_receivesFun($store_id,$product_ids);
    ...
    public function transfer_or_receivesFun($store_id,$product_ids){
    ...
    public function online_salesFun($store_id,$product_ids){
    ...
    public function sales_return_listsFun($store_id,$product_ids){
        return DB::table('sales_return_lists')
                                ->leftJoin(
                                    'products',
                                    'products.id',
                                    '=',
    ...
    public function lifting_returnFun($store_id,$product_ids){
             return DB::table('lifting_return_lists')
                                ->leftJoin(
                                    'products',
                                    'products.id',
                                    '=',
    ...
    public function liftingFun($store_id,$product_ids){
                            return DB::table('lifting_products')
                                ->leftJoin('products', 'products.id', '=', 'lifting_products.product_id')
                                ->leftJoin('product_prices', 'product_prices.product_id', '=', 'products.id')
                                ->leftJoin('attributes', 'attributes.id', '=', 'products.attribute_id')
                                ->leftJoin('categories', 'categories.id', '=', 'products.category_id')
    ...
    public function salesFun($store_id,$product_ids){
         return DB::table('sales_lists')
                            ->leftJoin(
                                'products',
                                'products.id',
                                '=',
