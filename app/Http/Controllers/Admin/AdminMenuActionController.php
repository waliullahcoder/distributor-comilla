            ...
            return DataTables::eloquent($model)
                ...
                ->addColumn('actions', function ($row) {
                    $actionBtn = '<div class="btn-group">
                                <a href="' . Route('admin.admin-menuAction.edit', $row->id) . '" class="btn btn-sm btn-warning border-0 px-10px tt link-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="far fa-pencil-alt"></i></a>
                                <button type="button" class="btn btn-sm btn-danger border-0 px-10px tt link-delete" data-url="' . Route('admin.admin-menuAction.destroy', $row->id) . '" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="far fa-trash-alt"></i></button>';
                    $actionBtn .= '</div>';
                    return $actionBtn;
                })
