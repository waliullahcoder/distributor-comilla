            ...
            return DataTables::eloquent($model)
                ...
                ->addColumn('actions', function ($row) {
                    ...
                    if (Auth::user()->can('admin.admin-menuAction.index')) {
                        $actionBtn = '<a href="' . Route('admin.admin-menuAction.index', $row->id) . '" class="btn btn-sm btn-primary mw-fit border-0 px-10px tt" data-bs-toggle="tooltip" data-bs-placement="top" title="View Actions"><i class="fas fa-eye"></i></a>';
                    }
