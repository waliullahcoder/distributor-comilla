...
class CampaignFaqController extends Controller
{
    public $path;
    public $title;
    public $create_title;
    ...
    {
        $this->path = 'campaign-faq';
        $this->title = 'Campaign Faqs';
        $this->create_title = 'Add Faq';
        $this->edit_title = 'Update Faq';
        $this->model = CampaignFaq::class;
    }
