<div class="navbar-header bg-white shadow-sm">
    <div class="px-sm-3 px-10px d-flex gap-2 align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-3">
            ...
            {{-- <button class="brand-toggle btn btn-sm px-0 d-inline-flex align-items-center">
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown ms-sm-3 header-item topbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-end w-100 rounded-0" style="min-width: 200px;">
                    ...
                    <a class="d-block fs-13 px-3 py-2 hov-bg-light"
                        href="{{ Auth::user()->role == 1 ? Route('admin.profile.index') : Route('client.profile.index') }}"><i
                            class="fad fa-user me-1 fs-15"></i> <span>Profile</span></a>
                    <a class="d-block fs-13 px-3 py-2 hov-bg-light"
                        href="{{ Auth::user()->role == 1 ? Route('admin.logout') : Route('client.logout') }}"> <i
