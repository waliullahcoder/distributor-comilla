...
@section('content')
    <div class="row g-3">
        ...
        <div class="col-md-4 col-sm-6">
            <label for="total_delivered_qty" class="form-label"><b>Total Delivered<span
                        class="text-danger">*</span></b></label>
            <input type="text" id="total_delivered_qty" class="form-control" value="0" readonly>
        </div>
        <div class="col-md-4 col-sm-6">
            <label for="total_delivered_amount" class="form-label"><b>Total Delivered Amount <span
                        class="text-danger">*</span></b></label>
                                ...
                                var tr =
                                    `<tr data-id="${item.id}">
                                        ...
                                        <td class="text-center">
                                            <input type="number" class="form-control text-center input-sm" style="width: 110px;" step="any" id="receive_${item.id}" name="receive[${item.id}]" max="" value="0">
                                        </td>
                                        <td>
                                            <input type="hidden" id="due_${item.id}" value="${item.due}">
                                            <input type="hidden" name="order_id[]" value="${item.id}">
                                            <select class="form-select select-sm status" id="status_${item.id}" name="status[${item.id}]" style="min-width: 110px;">
