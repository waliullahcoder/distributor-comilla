    ...
    <div class="row g-3">
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <div class="input-group">
                ...
                <button class="btn border rounded-0" id="alt_phone" type="button"><i
                        class="far {{ !is_null($data->user_phone_alt) ? 'fa-minus' : 'fa-plus' }}"></i></button>
            </div>
            <input type="number" class="form-control mt-1" id="user_phone_alt" name="user_phone_alt"
                placeholder="Customer Phone" style="display: {{ !is_null($data->user_phone_alt) ? 'block' : 'none' }};"
                value="{{ $data->user_phone_alt }}">
        </div>
        <div class="col-md-3 col-sm-6">
        ...
        <div class="col-md-9 col-sm-6">
            ...
            <input type="text" class="form-control" id="order_note" name="order_note"
                value="{{ $data->order_note }}" placeholder="Remarks">
        </div>
        <div class="col-sm-6">
                    ...
                    <tbody id="tbody">
                        @foreach ($data->products as $item)
                            <tr>
                                ...
                                <td><input style="min-width: 80px;" class="text-center rate" type="number"
                                ...
                                @endphp
                                <td><input style="min-width: 80px;" class="text-center qty" type="number"
                                        name="quantity[{{ $loop->iteration }}]" step="any"
                                        value="{{ $item->quantity }}" required></td>
                                <td><input style="min-width: 80px;" class="text-center amount" type="number"
                            ...
                            <td colspan="4">
                                <div class="input-group align-items-center mb-1 flex-nowrap justify-content-end">
                                    ...
                                    <input type="number" id="total_amount" name="total_amount" readonly
                                        class="form-control" style="min-width: 100px; max-width: 150px;"
                                        placeholder="Total Cost" value="{{ $data->sub_total }}">
                                ...
                                <div class="input-group align-items-center mb-1 flex-nowrap justify-content-end">
                                    ...
                                    <input type="number" id="discount" name="discount" class="form-control"
                                        style="min-width: 100px; max-width: 150px;" placeholder="Discount"
                                        value="{{ $data->discount }}">
                                    <span class="text-center" style="width: 40px;">TK.</span>
                                </div>
                                <div class="input-group align-items-center mb-1 flex-nowrap justify-content-end">
                                    ...
                                    <input type="number" id="advance" name="advance" class="form-control"
                                        style="min-width: 100px; max-width: 150px;" placeholder="Advance"
                                        value="{{ $data->advance }}">
                                    <span class="text-center" style="width: 40px;">TK.</span>
                                </div>
                                <div class="input-group align-items-center flex-nowrap justify-content-end">
                                    ...
                                    <input type="number" id="net_payable" name="net_payable" readonly
                                        ...
                                        value="{{ $data->total - $data->discount - $data->advance }}">
                                    <span class="text-center" style="width: 40px;">TK.</span>
                                </div>
                            </td>
                        </tr>
                            ...
                            if (response.status == 'success') {
                                var tr =
                                    `<tr>
                                        ...
                                        <td><input style="min-width: 120px;" class="text-center rate" type="number" name="price[${existing_key}]" step="any" value="${response.price}" required></td>
                                        <td><input style="min-width: 120px;" class="text-center qty" type="number" name="quantity[${existing_key}]" step="any" value="${response.quantity}" required></td>
                                        <td><input style="min-width: 120px;" class="text-center amount" type="number" name="amount[${existing_key}]" step="any" value="${response.amount}" required></td>
