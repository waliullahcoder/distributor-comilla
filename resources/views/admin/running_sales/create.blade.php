...
@section('content')
    <div class="row g-3 align-items-center">
        <div class="col-lg-3 col-md-4 col-sm-6">
            ...
            <input type="number" name="client_phone" id="client_phone" class="form-control" placeholder="Client Phone" required>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            ...
            <input type="text" class="form-control date_picker" id="date" name="date" required
                value="{{ date('d-m-Y', strtotime(old('date'))) }}" placeholder="Invoice Date">
        </div>
