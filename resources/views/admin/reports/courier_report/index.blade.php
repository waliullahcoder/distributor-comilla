...
@section('form')
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-3 col-sm-6">
            <label for="delivery_agent_id" class="form-label"><b>Delivery Agents</b></label>
            <select name="delivery_agent_id" id="delivery_agent_id" class="form-select select"
                data-placeholder="Select Delivery Agents">
                <option value=""></option>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            table.on('preXhr.dt', function(e, settings, data) {
                ...
                data.delivery_agent_id = $('#delivery_agent_id').val();
