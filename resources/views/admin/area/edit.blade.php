...
@section('content')
    <div class="row g-3">
        <div class="col-lg-4 col-sm-6">
            ...
            <select name="region_id" id="region_id" class="select form-select" data-placeholder="Select Region" required>
                ...
                @foreach ($regions as $region)
                    <option value="{{ $region->id }}" {{ $data->region_id == $region->id ? 'selected' : '' }}>
                        {{ $region->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="col-lg-4 col-sm-6">
            <label for="code" class="form-label"><b>Prefix</label>
        ...
        <div class="col-sm-6">
            ...
            <input type="number" class="form-control" id="shipping_charge" name="shipping_charge"
                value="{{ $data->shipping_charge }}" placeholder="Shipping Charge">
        </div>
        <div class="col-sm-6">
