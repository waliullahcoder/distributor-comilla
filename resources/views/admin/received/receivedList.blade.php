        ...
        <table id="dataTable" name="paymentRecordTable" class="table table-bordered table-sm">
            <thead>
                <tr>
                    ...
                    <th class="text-end" width="100px">Received Qty</th>
            ...
            @if (count($vendors) > 0)
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:20%">
                            <a class="btn btn-sm btn-primary" href="{{Route('admin.purchase.receive.edit', $row->id)}}" title="receive"><i class="fal fa-edit"></i> receive</a>
                            @if($row->total_delivery>0)
                            <a class="btn btn-sm btn-warning" href="{{route('admin.print.receive', $row->id)}}" target="_blank"  title="Delivery"><i class="fal fa-truck"></i> Print</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
