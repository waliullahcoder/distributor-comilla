            ...
            <table class="table table-bordered table-striped target-table align-middle mb-0">
                ...
                <tbody id="tbody">
                    @foreach ($data->list as $key => $item)
                        <tr>
                            <td class="text-center" width="80"><b class="serial">{{ $key + 1 }}</b>
                            ...
                            <td><input type="number" class="form-control" placeholder="Rate" name="rate[]" readonly
                                    value="{{ $item->rate }}"></td>
                            <td><input type="number" class="form-control" placeholder="Quantity" name="qty[]"
                                    readonly value="{{ $item->qty }}"></td>
                            <td><input type="text" class="form-control" placeholder="Unit" readonly
                                    value="{{ $item->product->attribute->name }}"></td>
                            <td><input type="number" class="form-control" placeholder="Amount" name="amount[]" readonly
                        ...
                        <td colspan="2">
                            ...
                            <div class="input-group align-items-center">
                                <input type="number" id="net_payable" name="net_payable" class="form-control" readonly
                                    placeholder="net Payable" value="{{ $data->total_amount - $data->discount }}">
                                <b class="text-center" style="width: 40px;">TK.</b>
                            </div>
                        </td>
                    </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#add_item', function(e) {
                ...
                if (product_id == 'NULL' && order_product_id == 'NULL') {
                    Swal.fire({
                        width: "22rem",
                        position: 'top-right',
                        toast: true,
                        ...
                        if (response.status == 'success') {
                            var tr =
                                `<tr class ="${(response.pre_order_product == 'true' ?
                                    ...
                                    <td><input type="number" class="form-control" placeholder="Rate" name="rate[]" readonly value="${ response.price }"></td>
                                    <td><input type="number" class="form-control" placeholder="Quantity" name="qty[]" readonly  value="${ response.quantity }"></td>
                                    <td><input type="text" class="form-control" placeholder="Unit" readonly value="${ response.unit }"></td>
                                    <td><input type="number" class="form-control" placeholder="Amount" name="amount[]" readonly value="${ response.amount }"></td>
