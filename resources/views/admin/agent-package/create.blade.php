...
@section('content')
    <div class="row g-3 align-items-center">
        <div class="col-lg-4 col-sm-6">
            ...
            <select name="delivery_agent_id" id="delivery_agent_id" class="form-select select"
                ...
                @foreach ($agents as $item)
                    <option value="{{ $item->id }}" {{ old('delivery_agent_id') == $item->id ? 'selected' : '' }}>
                        {{ $item->name }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <input type="number" class="form-control" id="base_rate" name="base_rate" value="{{ old('base_rate') }}"
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <input type="number" class="form-control" id="base_weight" name="base_weight" value="{{ old('base_weight') }}"
                placeholder="Base Weight" required>
        </div>
        <div class="col-lg-4 col-sm-6">
            ...
            <input type="number" class="form-control" id="additional_rate" name="additional_rate"
                value="{{ old('additional_rate') }}" placeholder="Additional Rate" required>
        </div>
        <div class="col-lg-4 col-sm-6">
            ...
            <select name="return_charge_type" id="return_charge_type" class="form-select select"
                ...
                <option value="Fixed Charge" {{ old('return_charge_type') == 'Fixed Charge' ? 'selected' : '' }}>Fixed
                    Charge</option>
                <option value="Delivery Charge" {{ old('return_charge_type') == 'Delivery Charge' ? 'selected' : '' }}>As
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <input type="number" class="form-control" id="return_charge" name="return_charge"
                value="{{ old('return_charge') }}" placeholder="Return Charge"
                {{ old('return_charge_type') == 'Delivery Charge' ? 'readonly' : 'required' }}>
        </div>
        <div class="col-12">
            <div class="custom-control custom-checkbox d-inline-block me-lg-5 me-sm-4 me-3 mt-2">
                <input type="checkbox" class="custom-control-input multi_checkbox" id="inside_dhaka" name="inside_dhaka"
                    value="1" {{ old('inside_dhaka') == '1' ? 'checked' : '' }}>
            ...
            <div class="custom-control custom-checkbox d-inline-block me-lg-5 me-sm-4 me-3 mt-2">
                <input type="checkbox" class="custom-control-input multi_checkbox" id="subarea_dhaka" name="subarea_dhaka"
                    value="1" {{ old('subarea_dhaka') == '1' ? 'checked' : '' }}>
            ...
            <div class="custom-control custom-checkbox d-inline-block me-lg-5 me-sm-4 me-3 mt-2">
                <input type="checkbox" class="custom-control-input multi_checkbox" id="inside_chittagong"
                    name="inside_chittagong" value="1" {{ old('inside_chittagong') == '1' ? 'checked' : '' }}>
            ...
            <div class="custom-control custom-checkbox d-inline-block me-lg-5 me-sm-4 me-3 mt-2">
                <input type="checkbox" class="custom-control-input multi_checkbox" id="subarea_chittagong"
                    name="subarea_chittagong" value="1" {{ old('subarea_chittagong') == '1' ? 'checked' : '' }}>
            ...
            <div class="custom-control custom-checkbox d-inline-block me-lg-5 me-sm-4 me-3 mt-2">
                <input type="checkbox" class="custom-control-input multi_checkbox" id="district_level" name="district_level"
                    value="1" {{ old('district_level') == '1' ? 'checked' : '' }}>
