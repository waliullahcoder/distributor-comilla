...
<div class="content-wrapper">
    <table class="table mb-0 header-table" style="border: 2px solid black;">
        ...
        <tr>
            ...
            <td class="text-right">
                <b class="d-inline-block text-left">Car Number :</b>
                <span class="d-inline-block" style="min-width: 130px;">{{ @$data->staff->car_number }}</span>
            </td>
        </tr>
        <tr>
            <td>
                <b class="d-inline-block" style="min-width: 100px;">Driver :</b>
                <span class="d-inline-block" style="min-width: 200px;">{{ @$data->staff->name }}</span>
            </td>
            <td class="text-right">
                <b class="d-inline-block text-left">Driver's Phone :</b>
    ...
    <table class="table info-table align-middle" style="border: 2px solid black; margin-top: -2px; margin-bottom: 5px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="50">{{ @$item->qty-@$item->delivery }}</td>
        ...
        <tfoot>
            ...
            <tr>
                <td class="text-right" colspan="5"><b>Discount Amount :</b></td>
                <td class="text-right" width="70">{{ number_format($total_discount_amount, 2, '.', ',') }}</td>
            </tr>
            @endif
            <tr>
                <td class="text-right" colspan="5"><b>Net Invoice Amount :</b></td>
                <td class="text-right" width="70">
