    ...
    <div class="row g-3">
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <input type="text" class="form-control date-range" name="date_range" id="date_range"
                ...
                value="{{ !is_null(request('start_date')) && !is_null(request('end_date')) ? date('d-m-Y', strtotime(request('start_date'))) . ' to ' . date('d-m-Y', strtotime(request('end_date'))) : date('01-m-Y') . ' to ' . date('t-m-Y') }}">
        </div>
    </div>
@endsection
